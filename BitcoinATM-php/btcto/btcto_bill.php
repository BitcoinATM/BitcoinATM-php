...
<input type="submit" id="Button1" onclick="window.location.href='btcto_buy.php'; ;return false;" name="" value="Place Order" style="position:absolute;left:370px;top:360px;width:250px;height:40px;border:1px #000000 dotted;background-color:transparent;font-family:Verdana;font-size:29px;z-index:3">
...
<img src="images/btcto.png" id="Image3" alt="" border="0" style="width:388px;height:60px;"></div>
