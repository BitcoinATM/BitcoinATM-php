...
<script type="text/javascript">
	...
	function isValid(address) {
		addressIsValid = (address.length == 34);
		if (addressIsValid) {
...
<script type="text/javascript">
	function goMtGox() {
		...
		var address = document.getElementById('address').value;
		if (isValid(address)) {
			window.location.href = "mtgox/insertBills.php?address=" + document.getElementById('address').value;
		}
	}
</script>
</head>
<body onclick="startTimer('goMtGox();');" style="overflow:hidden;">
...
<input type="text" id="address" onkeydown="addressKeyDown();" onkeyup="addressKeyUp();" onchange="addressChange();" onblur="addressBlur();"
	...
	name="address" value="<?php echo (isset($_GET['address'])) ? $_GET['address'] : '';?>" maxlength="34" />
...
<img src="images/qrlogo.jpg" id="Image5" alt="" border="0" style="width:100px;height:100px;"></div>
...
<img src="images/img0013.gif" id="Shape5" alt="" title="" style="border-width:0;width:230px;height:110px"></div>
...
<img src="images/TradeHill.jpg" id="Image7" alt="" border="0" style="width:219px;height:80px;"></div>
...
<img src="images/bitcoinclient.png" id="Image8" alt="" border="0" style="width:104px;height:69px;"></div>
...
<!--<img src="images/middle-finger.jpg" style="margin:0;padding:0;position:absolute;left:300px;top:150px;z-index:1005;opacity:.86;" />-->
</body>
</html>