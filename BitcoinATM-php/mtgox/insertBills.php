...
<input type="button" disabled="disabled" onclick="placeOrder();" id="placeOrderButton" name="" value="Place Order" style="position:absolute;left:370px;top:360px;width:250px;height:40px;border:1px #000000 dotted;background-color:transparent;font-family:Verdana;font-size:29px;z-index:3">
...
<font style="font-size:21px" color="#000000" face="Arial"><b>Cash Inserted: $<span id="usdBalance">0</span></b></font></div>
...
<font style="font-size:21px" color="#000000" face="Arial"><b>Bitcoins to buy: &#3647;<span id="btcBalance">0</span> </b></font></div>
</div>
</form>
